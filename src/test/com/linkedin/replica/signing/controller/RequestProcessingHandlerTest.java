...
import com.linkedin.replica.signing.controller.handlers.RequestProcessingHandler;
...
public class RequestProcessingHandlerTest {
    ...
    public static void setup() throws IOException{
        ...
        String[] a = {"src/main/resources/config/app.config",
                ...
                "src/main/resources/config/command.config",
    ...
    public void testAddingCommand() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException{
        ...
        assertEquals(Configuration.getInstance().getCommandConfigProp("signing.test"), "testCommand");
        assertEquals(Configuration.getInstance().getCommandConfigProp("signing.test.handler"), "ArangoSigningHandler");
        // delete added file
    ...
    public void testDeletingCommand() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException{
        ...
        htbl.put("configPropKey", "signing.test");
        ...
        // check that app.config file was updated
        assertNotEquals(Configuration.getInstance().getCommandConfigProp("signing.test"), "testCommand");
        assertNotEquals(Configuration.getInstance().getCommandConfigProp("signing.test.handler"), "ArangoSigningHandler");
    }
    ...
    public void testMissingParameter() throws IOException{
        ...
        htbl.put("handler", "ArangoSigningHandler");
